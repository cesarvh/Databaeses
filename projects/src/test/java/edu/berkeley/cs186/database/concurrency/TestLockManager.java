...
public class TestLockManager {
  ...
  @Test
  public void ZRELEASINGtestSharedAndExclusiveDifferentTransactionsLockManager() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
  ...
  public void testTwoExclusiveDifferentTransactionLockManager() throws InterruptedException {
    ...
    thread2.start();
    thread2.join(100); //waits for thread to finish (timeout of .1 sec)
//    assertTrue(lockMan.holdsLock("A", 2, LockManager.LockType.EXCLUSIVE)); //T1 should have exclusive lock
